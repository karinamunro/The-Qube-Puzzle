...
Note: Click **Help**&#8594;**Keyboard Shortcuts** for shortcuts on all the functionalities. There are also some secret moves that are accessible only by clicking particular keys, which are not listed in **Help**. See if you can find these moves.
